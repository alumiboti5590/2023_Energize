...
public class Shoulder extends SubsystemBase {
    ...
    private DoubleSolenoid.Value COAST_MODE = DoubleSolenoid.Value.kForward, BRAKE_MODE = DoubleSolenoid.Value.kReverse;
    ...
    public Shoulder(BooleanSupplier armExtendedCheck, DoubleSupplier feedForwardMultCheck) {
        this.motor = new CANSparkMax(RobotProperty.SHOULDER_MOTOR_ID.getInteger(), MotorType.kBrushless);
        ...
        pidController.setOutputRange(Constants.Shoulder.PERCENTAGE_MIN, Constants.Shoulder.PERCENTAGE_MAX);
