...
public class Intake extends SubsystemBase {
    ...
    public Intake() {
        ...
        velocityModeMap.put(
                VelocityMode.CONE_INTAKE, determineRPMVelocityTarget(Constants.Intake.VelocityRPM.CONE_INTAKE));
        velocityModeMap.put(
                VelocityMode.CUBE_INTAKE, determineRPMVelocityTarget(Constants.Intake.VelocityRPM.CUBE_INTAKE));
        velocityModeMap.put(VelocityMode.REVERSE, determineRPMVelocityTarget(Constants.Intake.VelocityRPM.REVERSE));
    ...
    private void configureClosedLoopEncoder() {
        ...
        this.intakeMotor.config_kF(
                Constants.Intake.Encoder.SLOT_ID, Constants.Intake.PID_GAINS.kF, Constants.Intake.Encoder.TIMEOUT_MS);
        this.intakeMotor.config_kP(
                Constants.Intake.Encoder.SLOT_ID, Constants.Intake.PID_GAINS.kP, Constants.Intake.Encoder.TIMEOUT_MS);
        this.intakeMotor.config_kI(
                Constants.Intake.Encoder.SLOT_ID, Constants.Intake.PID_GAINS.kI, Constants.Intake.Encoder.TIMEOUT_MS);
        this.intakeMotor.config_kD(
                Constants.Intake.Encoder.SLOT_ID, Constants.Intake.PID_GAINS.kD, Constants.Intake.Encoder.TIMEOUT_MS);
    }
