...
public class RobotPropertyTest {
    ...
    void valueWithInt() {
        ...
        int expected = Integer.parseInt(RobotProperties.getInstance().getProperty("drivetrain_left_follower_id"));
    ...
    void valueWithDouble() {
        RobotProperties.UNSAFE_setSingleton(FULL);
        double expected = Double.parseDouble(RobotProperties.getInstance().getProperty("standard_drive_speed"));
    ...
    void valueWithBoolean() {
        RobotProperties.UNSAFE_setSingleton(FULL);
        boolean expected = Boolean.parseBoolean(RobotProperties.getInstance().getProperty("intake_motor_invert"));
